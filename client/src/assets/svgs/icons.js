...
export const Minimize = ({ className, style }) => (
    <svg
...
export const ChevrionDown = ({ className, style }) => (
    <a.svg
        style={style}
        className={className}
        xmlns="http://www.w3.org/2000/svg"
...
export const SearchMagnifier = ({ className, iconColor = "dark-grey" }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        ...
        fill="none"
        stroke="currentColor"
        style={{ stroke: `var(--color-${iconColor})` }}
        strokeWidth="3"
        strokeLinecap="round"
        strokeLinejoin="round"
    >
...
export const Send = ({ className, onClick }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        onClick={onClick}
...
export const Security = ({ className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const Filters = ({ className, style }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const DoubleChevronLeft = ({ className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const Menu = ({ className, style, onClick }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const ChatCircle = ({ className, style, onClick }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const DoubleChevronRight = ({ className, style, onClick }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const TextFile = ({ onClick, className, style }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const ArrowDiag = ({ className, onClick, style }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const Mail = ({ className, style, onClick }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const Check = ({ className, style, onClick }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const List = ({ className, style, onClick, color }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="31"
        height="31"
...
export const Grid = ({ className, style, onClick, color }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        onClick={onClick}
        width="24"
